    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
              ...
              <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='25' min="0" required />
            </div>
        ...
        <button 
          type="submit" 
          disabled={loading} 
          className='w-36 py-3 mt-4 bg-black text-white disabled:opacity-50 flex items-center gap-2 justify-center'
        >
          {loading ? (
            <>
